    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-transparent">
      <div className="max-w-7xl mx-[100px] px-10 py-8 flex items-center justify-between text-white">
        ...
        <div className="hidden md:flex gap-12 text-sm font-medium tracking-widest uppercase">
          <Link to="/" className="hover:text-[#B4D7D8] transition flex items-center gap-2 group">
            <span className="opacity-30 group-hover:opacity-100 group-hover:text-[#AB9072] transition-all">—</span> Home
          </Link>
          <Link to="/marketplace" className="hover:text-[#B4D7D8] transition flex items-center gap-2 group">
            <span className="opacity-30 group-hover:opacity-100 group-hover:text-[#AB9072] transition-all">—</span> Marketplace
          </Link>
          <Link to="/activities" className="hover:text-[#B4D7D8] transition flex items-center gap-2 group">
            <span className="opacity-30 group-hover:opacity-100 group-hover:text-[#AB9072] transition-all">—</span> Activities
          </Link>
          <Link to="/booking" className="hover:text-[#B4D7D8] transition flex items-center gap-2 group">
