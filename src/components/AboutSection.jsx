        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--earth-slate)] leading-tight uppercase">
              ...
              <span className="text-[var(--earth-copper)]">
                Kadal Connects it all
              </span>
            </h2>

            <div className="space-y-4 max-w-lg">
              <p className="text-[var(--earth-slate)]/80 leading-relaxed font-medium">
                Kadal Connect is a digital bridge between coastal communities
                and the world beyond. Rooted in tradition and powered by modern
                technology, we help preserve coastal culture while creating
                sustainable opportunities for people who live by the sea.
              </p>
              <p className="text-[var(--earth-slate)]/90 leading-relaxed font-bold">
                We believe progress doesn’t mean erasing heritage. It means
                strengthening it — responsibly, transparently, and together.
              </p>
            </div>
